...
export default function PoliticianProfilePage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <Card className="dark:bg-gray-800 dark:border-gray-700">
            <CardContent className="py-12 text-center">
              ...
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Politicien non trouvé</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Le politicien demandé n&apos;existe pas ou n&apos;a pas encore été audité.
              </p>
              <Link href="/score">
                <button className="text-[#1E3A8A] dark:text-blue-400 hover:underline flex items-center gap-2 mx-auto mb-6">
              ...
              <div className="border-t dark:border-gray-700 pt-6">
                ...
                <button
                  ...
                  disabled={isAuditing}
                  className="bg-[#1E3A8A] dark:bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-800 dark:hover:bg-blue-700 transition-colors flex items-center gap-2 mx-auto disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isAuditing ? (
                    <>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-[#1E3A8A] to-[#3B82F6] dark:from-blue-900 dark:to-blue-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {scores && (
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Scores IA - Audit Objectif</h2>
              ...
              <Card className="bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/30 dark:to-indigo-800/30 border-indigo-200 dark:border-indigo-700">
                ...
                <CardContent>
                  ...
                  <Progress
                    ...
                    className="h-2 mb-2 bg-indigo-200 dark:bg-indigo-700"
                  />
              ...
              <Card className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 border-green-200 dark:border-green-700">
                ...
                <CardContent>
                  ...
                  <Progress
                    ...
                    className="h-2 mb-2 bg-green-200 dark:bg-green-700"
                  />
              ...
              <Card className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/30 dark:to-amber-800/30 border-amber-200 dark:border-amber-700">
                ...
                <CardContent>
                  ...
                  <Progress
                    ...
                    className="h-2 mb-2 bg-amber-200 dark:bg-amber-700"
                  />
                  <div className="text-xs text-amber-600 dark:text-amber-300 space-y-0.5">
              ...
              <Card className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 border-gray-200 dark:border-gray-600">
                ...
                <CardContent>
                  ...
                  <Progress
                    ...
                    className="h-2 mb-2 bg-gray-200 dark:bg-gray-600"
                  />
                      ...
                      {verification.promise && (
                        <>
                          ...
                          {verification.promise.category && (
                            <Badge variant="outline" className="text-xs mb-2 dark:border-gray-600 dark:text-gray-300">
                              {verification.promise.category}
                            </Badge>
                          )}
                          ...
                          {verification.promise.source_url && (
                            <a
                              ...
                              className="text-xs text-[#1E3A8A] dark:text-blue-400 hover:underline flex items-center gap-1"
                            >
                ...
                <div className="space-y-4">
                    ...
                    {monthlyActivity.map((month, index) => {
                      ...
                      return (
                        <div key={month.month} className="flex-1 flex flex-col items-center group relative">
                          ...
                          {/* Label */}
                          <span className="text-[10px] text-gray-500 dark:text-gray-400 mt-1 -rotate-45 origin-top-left whitespace-nowrap">
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t dark:border-gray-700">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-400">Votes sur 12 mois</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-gray-600 dark:text-gray-300">
                        {Math.round(monthlyActivity.reduce((sum, m) => sum + m.votes, 0) / monthlyActivity.length)}
                      </div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">Moyenne/mois</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-green-600 dark:text-green-400">
                        {Math.max(...monthlyActivity.map(m => m.votes))}
                      </div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">Max. mensuel</div>
                    </div>
                  </div>
              ...
              <CardContent>
                <div className="space-y-3">
                  {actions.map((action) => (
                    <div
                      key={action.id}
                      className="border-l-4 border-[#1E3A8A] dark:border-blue-500 pl-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                    >
                      <div className="flex items-start justify-between mb-1">
                        <div className="flex items-center gap-2">
                          ...
                          {action.bill_id && (
                            <Badge variant="outline" className="text-xs bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 dark:border-blue-700">
                              {action.bill_id}
                            </Badge>
                          )}
                        </div>
                ...
                {actions.length < totalActionsCount && (
                  <div className="mt-4 text-center">
                    <button
                      ...
                      className="px-6 py-2 bg-[#1E3A8A] dark:bg-blue-600 text-white rounded-lg hover:bg-blue-800 dark:hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {loadingMore ? (
        ...
        {scores && (
          <div className="mb-8">
            <Card className="dark:bg-gray-800 dark:border-gray-700">
              <CardHeader>
                <CardTitle className="dark:text-gray-100">Statistiques Détaillées</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-gray-700 dark:text-gray-300 mb-3">Promesses</h4>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center p-2 bg-gray-50 dark:bg-gray-700 rounded">
                        <span className="text-sm dark:text-gray-300">Total vérifiées</span>
                        <span className="font-semibold dark:text-gray-100">
                          {(scores.promises_kept || 0) + (scores.promises_broken || 0) + (scores.promises_partial || 0)}
                        </span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-green-50 dark:bg-green-900/20 rounded">
                        <span className="text-sm text-green-800 dark:text-green-400">Tenues</span>
                        <span className="font-semibold text-green-800 dark:text-green-400">{scores.promises_kept || 0}</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-red-50 dark:bg-red-900/20 rounded">
                        <span className="text-sm text-red-800 dark:text-red-400">Brisées</span>
                        <span className="font-semibold text-red-800 dark:text-red-400">{scores.promises_broken || 0}</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-yellow-50 dark:bg-yellow-900/20 rounded">
                        <span className="text-sm text-yellow-800 dark:text-yellow-400">Partielles</span>
                        <span className="font-semibold text-yellow-800 dark:text-yellow-400">{scores.promises_partial || 0}</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-gray-50 dark:bg-gray-700 rounded">
                        <span className="text-sm dark:text-gray-300">En attente</span>
                        <span className="font-semibold dark:text-gray-100">{scores.promises_pending || 0}</span>
                      </div>
                    </div>
                  </div>

                  <div>
                    <h4 className="font-semibold text-gray-700 dark:text-gray-300 mb-3">Activité Parlementaire</h4>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center p-2 bg-gray-50 dark:bg-gray-700 rounded">
                        <span className="text-sm dark:text-gray-300">Sessions présent</span>
                        <span className="font-semibold dark:text-gray-100">{scores.sessions_attended || 0}</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-gray-50 dark:bg-gray-700 rounded">
                        <span className="text-sm dark:text-gray-300">Lois proposées</span>
                        <span className="font-semibold dark:text-gray-100">{scores.bills_sponsored || 0}</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-gray-50 dark:bg-gray-700 rounded">
                        <span className="text-sm dark:text-gray-300">Amendements</span>
                        <span className="font-semibold dark:text-gray-100">{scores.amendments_proposed || 0}</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-gray-50 dark:bg-gray-700 rounded">
                        <span className="text-sm dark:text-gray-300">Débats</span>
                        <span className="font-semibold dark:text-gray-100">{scores.debates_participated || 0}</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-gray-50 dark:bg-gray-700 rounded">
                        <span className="text-sm dark:text-gray-300">Questions</span>
                        <span className="font-semibold dark:text-gray-100">{scores.questions_asked || 0}</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        {/* Legal Disclaimer */}
        <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg text-xs text-gray-600 dark:text-gray-400">
          <p className="font-semibold mb-1 dark:text-gray-300">Méthodologie AI-Driven et Transparence :</p>
          <p>
            Tous les scores sont calculés automatiquement par IA à partir de données officielles vérifiables
            (Assemblée Nationale, Vigie du mensonge, sources gouvernementales). <strong className="dark:text-gray-200">100% objectif, 0% subjectif</strong> :
