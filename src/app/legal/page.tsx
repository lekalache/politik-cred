      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="mb-12">
          <Card className="border-blue-200 dark:border-blue-700 bg-blue-50 dark:bg-blue-900/20">
            <CardHeader>
              <CardTitle className="flex items-center space-x-2 dark:text-blue-200">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 dark:text-gray-100">Protection contre les campagnes coordonnées</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 dark:text-gray-100">Réponse rapide aux demandes légales</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 dark:text-gray-100">Documentation complète</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 dark:text-gray-100">Supervision éditoriale</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
