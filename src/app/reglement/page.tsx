  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="relative max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg dark:shadow-black/30 p-4 sm:p-8">
          ...
          <div className="relative z-10 max-w-4xl mx-auto prose prose-lg max-w-none text-gray-700 dark:text-gray-300 leading-relaxed">
            <div className="mb-8 text-center">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Règles de fonctionnement de Politik-Cred – Experimental</h2>
              <p className="text-sm text-gray-600 dark:text-gray-400">Dernière mise à jour : Décembre 2025</p>
            </div>

            <div className="mb-8 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700">
              <h3 className="text-xl font-semibold text-blue-900 dark:text-blue-200 mb-3">Objectif de la plateforme</h3>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">1. Fonctionnement de la Plateforme</h2>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">2. Extraction et Vérification des Promesses</h2>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Extraction des promesses</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Vérification contre actions parlementaires</h3>
            <ul className="mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">3. Statuts de Vérification</h2>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">4. Processus de Vérification Automatisée</h2>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Étape 1 : Extraction et classification</h3>
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Étape 2 : Comparaison avec les actions réelles</h3>
            <ul className="mb-4 space-y-2">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Étape 3 : Mise à jour automatique du score</h3>
            <ul className="mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">5. Sources acceptées</h2>
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Fiabilité maximale</h3>
            <ul className="mb-4 space-y-2">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Sources complémentaires (validation renforcée)</h3>
            <ul className="mb-4 space-y-2">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Sources exclues</h3>
            <ul className="mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">6. Vérification Multi-Sources</h2>
            <div className="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700">
              <p className="text-blue-800 dark:text-blue-200 mb-3"><strong>Système triple vérification :</strong></p>
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Garanties de fiabilité</h3>
            <ul className="mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">7. Score de Crédibilité</h2>
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Principe de base</h3>
            <ul className="mb-4 space-y-2">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Facteurs d&apos;évolution</h3>
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Transparence des calculs</h3>
            <ul className="mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">8. Droit de réponse et recours</h2>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Droit de réponse des élus</h3>
            <ul className="mb-4 space-y-2">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Recours pour les utilisateurs</h3>
            <ul className="mb-4 space-y-2">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Contre les abus</h3>
            <ul className="mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">9. Transparence et responsabilité</h2>
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Accès à l&apos;information</h3>
            <ul className="mb-4 space-y-2">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Données personnelles</h3>
            <ul className="mb-4 space-y-2">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Financement</h3>
            <ul className="mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">10. Évolution de la plateforme</h2>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Gouvernance participative</h3>
            <ul className="mb-4 space-y-2">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Amélioration continue</h3>
            <ul className="mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">11. Limites et précautions</h2>
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Ce que Politik-Cred n&apos;est pas</h3>
            <ul className="mb-4 space-y-2">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Principes essentiels</h3>
            <ul className="mb-6 space-y-2">
            ...
            <div className="mt-12 pt-6 border-t border-gray-200 dark:border-gray-600 text-sm text-gray-500 dark:text-gray-400 text-center">
              ...
              <p className="mt-2">
                ...
                <span className="text-blue-600 dark:text-blue-400 ml-1">reglement@politik-cred.fr</span>
              </p>
            </div>
          </div>
        </div>
