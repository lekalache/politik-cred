    ...
    <div className="rounded-lg border border-gray-200 bg-white shadow-sm overflow-hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-gray-900">
              ADN Politique
              {politicianName && <span className="text-gray-500 font-normal"> - {politicianName}</span>}
            </h3>
      ...
      {expanded && (
        <div className="border-t border-gray-200">
          {/* Value Distribution */}
          <div className="p-4">
            <h4 className="text-sm font-medium text-gray-700 mb-3">Distribution des priorités</h4>
          ...
          {profile.behavioral_patterns.length > 0 && (
            <div className="border-t border-gray-200 p-4">
              <h4 className="text-sm font-medium text-gray-700 mb-2">Profil comportemental</h4>
    ...
    <div className="space-y-1">
      <div className="flex items-center justify-between text-sm">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-500">
          ...
          {hasVerifications && (
            <span className={metrics.consistency_score >= 60 ? 'text-green-600' : 'text-red-600'}>
